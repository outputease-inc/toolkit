...
* **toolkit:** tooling audit phase 1, the toolkit half (#96)

## 0.4.5 (2026-09-03)

### Added

* **toolkit:** guard the privacy vendor list against dependency drift

### Fixed

* **toolkit:** close seven review findings in the vendor guard
* **toolkit:** close three gaps in the vendor guard found on review
* **toolkit:** derive vendor-guard backing from real deps, not the map
* **toolkit:** narrow leg 1b's unbacked-provider message to its scope

## 0.4.4 (2026-08-25)

### Added

* **toolkit:** offer i-have-adhd as a selectable output-style plugin
* **toolkit:** report the scaffolded payload from the facts export

### Fixed

* **toolkit:** heal generated agent configs, sync templates, and bake install facts
* **toolkit:** make every agent-stack entry reachable, and keep it that way
* **toolkit:** raise the CLAUDE.md size guard 760 -&gt; 810

## 0.4.3 (2026-08-06)

### Fixed

* **toolkit:** make a freshly scaffolded project pass its own quality gate

## 0.4.2 (2026-08-06)

### Added

* **toolkit:** export what the package contains as facts

### Fixed

* **toolkit:** make the spec-kit channel survive an upgrade (spec 010 US3)

### Changed

* **toolkit:** register CLI commands from one declarative list
