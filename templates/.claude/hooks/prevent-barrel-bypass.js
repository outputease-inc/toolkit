 ...
 * any scoped monorepo, not just one specific org); an unscoped project skips the deep-import
...
const MAX_INPUT = 1024 * 1024; // 1 MB so a whole-file Write reaches the check; warn-only, silent above it
...
/**
 * Derive the workspace package scope (e.g. "@myorg") by walking up from the
