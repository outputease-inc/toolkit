 ...
 *
 * Storage: newline-delimited absolute paths. Appends are safe here because a
 * session's hooks are effectively serialized and each append is one short line
 * (this is a regular file, not a POSIX pipe, so PIPE_BUF does not apply — and
 * the documented primary platform is Windows).
 *
