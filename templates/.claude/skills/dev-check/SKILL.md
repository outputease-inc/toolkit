---
name: dev-check
description: Fast development feedback (build/lint/test validation) in 60-90 seconds. Use before committing or claiming work complete — the evidence step of superpowers:verification-before-completion.
...
- /commit-commands:commit - Create proper commit when ready (if plugin installed)
```
...
- `/commit-commands:commit` - Proper conventional commit (plugin)
