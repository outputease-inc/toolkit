---
name: capture
description: Quick-capture an idea to the TODO.md Ideas Backlog as a [Raw] entry. Use when the user asks to capture, note, or backlog an idea for later ("capture this", "add to the backlog", "note this idea for later"), or supplies an idea to /capture inline.
