...
Examples:
- `/a11y-review packages/ui/src/components/Button.tsx`
- `/a11y-review apps/web/src/app/page.tsx`
...
- **`/frontend-design`** — Plugin-provided design skill (see PLUGINS-INDEX.md); considers accessibility but a11y-review provides deeper WCAG validation
