...
Examples:
- `/gen-test packages/types/src/schemas/user.ts`
- `/gen-test packages/api-client/src/fetchClient.ts`
- `/gen-test packages/db/src/client.ts`
...
- **create-migration** — After creating a schema, generate validation tests for Zod schemas
