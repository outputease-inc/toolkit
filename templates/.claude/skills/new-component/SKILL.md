...
import { cn } from "@outputease/ui/lib/utils";
...
- Use Tailwind CSS with brand tokens from `@outputease/brand`
...
- For UI primitives: update `packages/ui/src/index.ts`
...
**Name**: ComponentName
**Path**: packages/ui/src/components/[path]/ComponentName.tsx
...
### Usage
import { ComponentName } from "@outputease/ui";
```
...
- Use brand colors from `@outputease/brand`, never hardcode hex values
