...
| ----------------- | --------------------------------- | ----------------------------- |
| `/continue`   | Recovery check after interruption | After crashes, network issues |
| `/quickstart` | Normal session initialization     | Beginning of planned work     |

`/continue` is a diagnostic tool. After running it, you typically follow
