...
> `dependency-auditor`) occupy narrow domains not covered by installed plugin agents — verified
> in the 2026-07-01 config audit. For individual agent details, see each agent's frontmatter in
> `.claude/agents/`.
