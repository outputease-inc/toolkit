...
export const specKitResultSchema = z.object({
  ...
  /**
   * Skill names whose neutral source under `.agents/targets/claude/skills/` was created
   * or advanced to the freshly-installed upstream body (finding C1). Empty is the correct
   * result for an already-current project; it is NOT evidence the step was skipped.
   */
  refreshedSkills: z.array(z.string()),
