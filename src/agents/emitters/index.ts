...
import { claudeRules, instructionsAgentsMd, instructionsClaudeMd } from "./instructions-md";
...
import { opencodePassthrough } from "./opencode-passthrough";
...
export const EMITTER_REGISTRY: Record<EmitterFamily, Emitter> = {
  ...
  "opencode-passthrough": opencodePassthrough,
};
